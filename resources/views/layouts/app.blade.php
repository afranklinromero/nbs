            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              ...
              <ul class="navbar-nav">
                  @if( Auth::check())
                      ...
                      @else
                          <li class="nav-item "><a class="nav-link" href="">EXAMENES <span class="sr-only">(current)</span></a></li>
                      @endif
                  @endif
              </ul>
                  ...
                  <ul class="navbar-nav mr-auto">
                      @guest
                          <li style="margin-bottom: -25px;" class="nav-item ">
                              <a class="text-muted nav-link" href="{{ route('login') }}"><span class="menu_usuario mr-2" style="float:left;" > Ingresar </span> <i class="fas fa-user-circle fa-2x"> </i></a>
                          </li>
                      @else
                          <li class="dropdown">
