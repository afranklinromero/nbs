...
<!--<iframe id="iframe1" src="http://docs.google.com/gview?url=normasbolivianasdesalud/libros/{{ $documentopdf }}&embedded=true#:0.page.{{ $pagina }}">-->
    <iframe src="http://docs.google.com/gview?embedded=true&url=https://normasbolivianasdesalud.com/libros/{{ $documentopdf }}#:0.page.{{ $pagina }}" style="width:100%;" height="100%">

<!--<embed src="{{asset('libros')}}/{{$documentopdf}}#page={{$pagina}}" type='application/pdf' width='100%' height='100%'/>-->
