...
@include('blog.aside.error')
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['route'=>'blog.store', 'id'=>'form-blog-create']) !!}
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-title">
                                    ...
                                    {!! Form::text('titulo', null, ['class' => 'form-control', 'minlength'=>'5', 'maxlength'=>'64', 'required']) !!}
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-title">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p class="card-title">
                                    ...
                                    {!! Form::textarea('contenido', null, ['class' => 'form-control', 'minlength'=>'5', 'maxlength'=>'3074', 'required']) !!}
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="card-title">
                                    ...
                                    {!! Form::text('autor', null, ['class' => 'form-control', 'minlength'=>'5', 'maxlength'=>'64', 'required']) !!}
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p class="card-title">
                                    {!! Form::label('referencia', 'Referencia:', ['class' => 'form-label']) !!}
                                    {!! Form::text('referencia', null, ['class' => 'form-control', 'minlength'=>'5', 'maxlength'=>'64', 'required']) !!}
                                </p>
                            </div>
                        </div>
                    </div>
