...
class Marcador4Seeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Marcador::create([	'libro_id'=>'4', 	'tipomarcador_id'=>'1', 	'numero'=>'1', 	'nivel'=>'1', 	'nombre'=>'JUSTIFICACION', 	'pagina'=>'1', 	'vistaprevia'=>'1.PNG', 	'created_at'=>'2020-17-10', 	'updated_at'=>'2020-17-10', 	'estado'=>'1','esprimero' =>'1',]);
