...
//factory(Pregunta::class, 5)->make(['estado'=> '0']);
        ...
        Pregunta::create([	'PREGUNTA'=>'Es una META del Programa de Tuberculosis ', 	'tema_id'=>'2', 	]);
        Pregunta::create([	'PREGUNTA'=>'Paciente que presenta sintomas o signos sugetivos de tuberculosis', 	'tema_id'=>'2', 	]);
        Pregunta::create([	'PREGUNTA'=>'Tuberculosis bacteriologicamente confirmada', 	'tema_id'=>'2', 	]);
        Pregunta::create([	'PREGUNTA'=>'Tuberculosis bacteriologicamente confirmada', 	'tema_id'=>'2', 	]);
        Pregunta::create([	'PREGUNTA'=>'Según la localización anatómica de la enfermedad la tuberculosis se clasifica en', 	'tema_id'=>'2', 	]);
        ...
        Pregunta::create([	'PREGUNTA'=>'La fase intensiva del tratamiento de la tuberculosis resistente dura', 	'tema_id'=>'2', 	]);
